...
!(function () {
  var o = config.colors.white,
    ...
    s = {
      ...
      plotOptions: {
        bar: { horizontal: !1, columnWidth: '33%', borderRadius: 12, startingShape: 'rounded', endingShape: 'rounded' },
      },
      ...
      grid: { borderColor: r, padding: { top: 0, bottom: -8, left: 20, right: 20 } },
      xaxis: {
    ...
    (s = {
      ...
      plotOptions: {
        radialBar: {
          ...
          dataLabels: {
            name: { offsetY: 15, color: t, fontSize: '15px', fontWeight: '600', fontFamily: 'Public Sans' },
            value: { offsetY: -25, color: t, fontSize: '22px', fontWeight: '500', fontFamily: 'Public Sans' },
          },
        },
      },
  ...
  (o = document.querySelector('#incomeChart')),
    (t = {
      ...
      fill: {
        type: 'gradient',
        gradient: { shade: void 0, shadeIntensity: 0.6, opacityFrom: 0.5, opacityTo: 0.25, stops: [0, 95, 100] },
      },
      grid: { borderColor: r, strokeDashArray: 3, padding: { top: -20, bottom: -8, left: -10, right: 8 } },
      xaxis: {
        categories: ['', 'Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul'],
        axisBorder: { show: !1 },
        axisTicks: { show: !1 },
